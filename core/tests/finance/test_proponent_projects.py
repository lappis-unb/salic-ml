...
from core.utils.read_csv import read_csv, read_csv_as_string
...
class TestProponentProjects(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.dt_verified_funds = read_csv_as_string(csv_name, usecols=usecols)

        csv_name = 'planilha_projetos.csv'
        usecols = ['PRONAC', 'CgcCpf']
        self.dt_projects = read_csv_as_string(csv_name, usecols=usecols)
    ...
    def test_IO(self):
        csv_name = 'planilha_comprovacao.csv'
        usecols = ['PRONAC', 'proponenteCgcCpf']
        csv = read_csv_as_string(csv_name, usecols=usecols)
    ...
    def test_proponent_with_submitted_project(self):
        pronac = '079172'  # '00274080001' -> CGCCPF
