...
class TestFinancialMetrics(unittest.TestCase):
    ...
    def test_get_metrics_verified_funds(self):
        ...
        expected_keys = ["is_outlier", "total_verified_funds", "maximum_expected_funds"]
    ...
    def test_get_metrics_raised_funds(self):
        ...
        expected_keys = ["is_outlier", "total_raised_funds", "maximum_expected_funds"]
        map(lambda key: self.assertIn(key, response_funds), expected_keys)
    ...
    def test_new_providers(self):
        ...
        map(lambda key: self.assertIn(key, response_new_providers), expected_keys)
    ...
    def test_calculate_easiness_keys(self):
        ...
        filter(lambda x: self.assertIn(x, metrics[EASINESS_KEY]), EXPECTED_KEYS)
    ...
    def test_items_prices(self):
        ...
        map(lambda key: self.assertIn(key, expected_keys), expected_keys)
