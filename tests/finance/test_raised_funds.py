...
from salicml.metrics.finance.raised_funds import RaisedFunds
...
class TestRaisedFunds(unittest.TestCase):
    def setUp(self):
        ...
        self.dt_raised_funds = read_csv_with_different_type(
            "planilha_captacao.csv", {"Pronac": str}, usecols=usecols
        )
